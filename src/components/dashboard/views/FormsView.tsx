  ...
  return (
    <div className="max-w-5xl mx-auto py-8 px-4 sm:px-6 space-y-6 font-sans">
      ...
      <div className="space-y-4">
        <div className="bg-white border border-gray-200 rounded-2xl p-5 shadow-xs hover:border-gray-300 transition-all flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                <h3 className="text-base font-bold text-gray-900">{formTitle}</h3>
                <span className="w-2 h-2 rounded-full bg-emerald-500" title="Active"></span>
              </div>

              {/* URL Chip */}
              <div className="inline-flex items-center gap-2 px-2.5 py-1 rounded-lg bg-gray-50 border border-gray-200 text-xs text-gray-600 font-mono">
                <span className="truncate max-w-xs">{collectionUrl}</span>
                <button
                  onClick={handleCopy}
              ...
              <div className="flex items-center gap-2 pt-1">
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-3 py-1 rounded-lg bg-purple-50 hover:bg-purple-100 text-[#6701e6] border border-purple-200 text-xs font-semibold transition-colors cursor-pointer"
                >
                ...
                <button
                  onClick={onViewProof}
                  className="inline-flex items-center gap-1.5 px-3 py-1 rounded-lg bg-gray-50 hover:bg-gray-100 text-gray-700 border border-gray-200 text-xs font-semibold transition-colors cursor-pointer"
                >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6 border-t lg:border-t-0 lg:border-l border-gray-100 pt-4 lg:pt-0 lg:pl-6 shrink-0">
            <div className="text-center">
              <span className="block text-lg font-bold text-gray-900">0</span>
              <span className="text-[11px] text-gray-400 font-medium">invites</span>
            </div>
            <div className="text-center">
              <span className="block text-lg font-bold text-gray-900">1</span>
              <span className="text-[11px] text-gray-400 font-medium">unique visits</span>
            </div>
            <div className="text-center">
              <span className="block text-lg font-bold text-gray-900">0</span>
            ...
            <div className="text-center">
              ...
              <span className="text-[11px] text-gray-400 font-medium">response rate</span>
            </div>
          </div>
