            ...
            return (
              ...
              >
                ...
                <span className={`px-1.5 py-0.2 rounded-full text-[11px] font-bold ${
                  isActive ? 'bg-purple-100 text-[#6701e6]' : 'bg-gray-200 text-gray-600'
                }`}>
                  {tab.count}
                </span>
              </button>
        ...
        <div className="flex items-center gap-2 self-end lg:self-auto">
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-white hover:bg-gray-50 border border-gray-200 text-xs sm:text-sm font-semibold text-gray-700 shadow-xs transition-colors cursor-pointer"
            >
            ...
            {showExportMenu && (
              <>
                ...
                />
                <div className="absolute right-0 mt-1 w-36 bg-white rounded-xl border border-gray-200 shadow-xl z-30 py-1 overflow-hidden animate-slide-up">
                  <button
                    onClick={() => {
                      onExportJSON();
                      setShowExportMenu(false);
                    }}
                    className="w-full text-left px-3.5 py-2 text-xs font-medium text-gray-700 hover:text-gray-950 hover:bg-gray-100 transition-colors cursor-pointer"
                  >
                    Export JSON
                  </button>
                  <button
          ...
          <button
            ...
            className="p-2 rounded-xl bg-white hover:bg-gray-50 border border-gray-200 text-gray-600 hover:text-gray-900 shadow-xs transition-colors cursor-pointer"
          >
