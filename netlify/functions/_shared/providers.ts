/**
 * SocialProvider abstraction for ReviewVault Social Distribution Hub.
 * Defines the unified contract for direct social publishing across platforms.
 * Phase 1: LinkedIn (Active Official API)
 * Phase B: X (Twitter), Facebook, Instagram
 */
...
/**
 * Official LinkedIn Provider (Phase 1)
 * Uses official LinkedIn Posts API (/rest/posts) and Images API (/rest/images).
 */
...
/**
 * Official X (Twitter) Provider (Phase B Architecture)
 * Requires X Developer App with Basic/Pro Tier (OAuth 2.0 PKCE + tweet.write, users.read).
 */
...
/**
 * Official Facebook Provider (Phase B Architecture)
 * Requires Meta Graph API with pages_manage_posts and pages_read_engagement.
 */
...
/**
 * Official Instagram Provider (Phase B Architecture)
 * Requires Meta Graph API with instagram_content_publish linked to an Instagram Business account.
 */
